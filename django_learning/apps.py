...
class DjangoLearningConfig(AppConfig):
    ...
    def ready(self):
        ...
        for setting, path in [
            ...
            ("DJANGO_LEARNING_PROJECT_QUALIFICATION_SCORERS", "utils/project_qualification_scorers"),
            ("DJANGO_LEARNING_PROJECT_QUALIFICATION_TESTS", "utils/project_qualification_tests"),
        ...
        for template in templates:
            template["DIRS"] = template["DIRS"] + settings.DJANGO_LEARNING_HIT_TEMPLATE_DIRS
