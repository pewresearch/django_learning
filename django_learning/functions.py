...
def filter_assignments(
    ...
    if completed and not incomplete: assignments = assignments.filter(time_finished__isnull=False)
    elif incomplete and not completed: assignments = assignments.filter(time_finished__isnull=True)
