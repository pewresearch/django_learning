...
default_app_config = "django_learning.apps.DjangoLearningConfig"
...
print(
    "Using django_learning.sklearn_mods._ProbaScorer instead of sklearn.metrics.scorer._ProbaScorer"
)
print(
    "Using django_learning.sklearn_mods._fit_and_score instead of sklearn.model_selection._validation._fit_and_score"
)
print(
